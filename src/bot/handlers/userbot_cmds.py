        ...
        try:
            ...
            if reason.startswith("NO_RESULTS"):
                ...
                if COOKIES_STATUS == "invalid":
                    ...
                    text = (
                        "🤖 با اینکه کوکی تنظیم شده، یوتیوب همچنان این درخواست "
                        "رو ربات تشخیص داده.\n"
                        "احتمالاً کوکی منقضی شده یا حسابش به اندازهٔ کافی "
                        "«قدیمی/معتبر» نیست. یک‌بار دوباره از حسابِ یوتیوب لاگین "
                        "کن، کوکی رو تازه اکسپورت کن و دوباره توی Render ست کن.\n"
                        "فعلاً می‌تونی فایلِ صوتی رو مستقیم بفرستی و روش ریپلای "
                        "کنی و بنویسی «پخش»."
                    )
                else:
