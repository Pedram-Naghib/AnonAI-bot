...
def _build_help_text(bot_username: str) -> str:
    return (
        ...
        "<u>پخش از فایلِ آپلودشده:</u> روی یک فایلِ صوتی، ویس، ویدیو یا پیامِ "
        "ویدیویی ریپلای کن و بنویس:\n<code>پخش</code>\n\n"
        "<u>پخش از یوتیوب با اسم آهنگ:</u>\n<code>پخش اسمِ آهنگ یا خواننده</code>\n"
        "مثال: <code>پخش shape of you</code>\n\n"
        ...
        "• <code>پنل</code> — نمایشِ دوبارهٔ پنلِ کنترل با دکمه‌های شیشه‌ای\n\n"
